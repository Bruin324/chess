...
public class Knight extends Piece {
    ...
    public Collection<Move> calculateLegalMoves(final Board board) {
        ...
        for(final int currentCandidateOffset : CANDIDATE_MOVE_COORDINATES) {
            final int candidateDestinationCoordinate = this.piecePostion + currentCandidateOffset;
            if (BoardUtils.isValidTileCoordinate(candidateDestinationCoordinate)) {
                if(isFirstColumnExclusion(this.piecePostion, currentCandidateOffset) ||
                        isSecondColumnExclusion(this.piecePostion, currentCandidateOffset) ||
                        isSeventhColumnExclusion(this.piecePostion, currentCandidateOffset) ||
